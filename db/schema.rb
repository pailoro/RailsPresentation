...
ActiveRecord::Schema.define(version: 20190212194710) do
  ...
  create_table "advertisers_categories", force: :cascade do |t|
    t.string "name"
    t.string "slug"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "afiliadas", force: :cascade do |t|
    t.string "name"
    t.string "razao_social"
    t.string "phone"
    t.string "cnpj"
  ...
  create_table "emissoras", force: :cascade do |t|
    t.string "name"
    t.string "photo"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
